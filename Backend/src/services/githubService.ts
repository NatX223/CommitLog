...
export class GitHubService {
   ...
   */
  async getUserCommitsSince(username: string, since: Date, repo: string, until?: Date): Promise<GitHubCommit[]> {
    try {
    ...
    try {
        ...
        console.warn(`Error fetching commits from ${repo}:`, repoError);
    }
